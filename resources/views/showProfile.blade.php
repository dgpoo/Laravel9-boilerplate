                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.profile_update') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-2">
                                <img src="{{ asset('img/profile/' . $users->image) }}" id="Image" name="Image" height=50 widht=50 >
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                               <select name="role" id="role[]" class="form-control">
                                   <option value="Role 1" {{ $users->role == "Role 1" ? 'selected' : '' }}>Role 1</option>
                                   <option value="Role 2" {{ $users->role == "Role 2" ? 'selected' : '' }}>Role 2</option>
                                   <option value="Role 3" {{ $users->role == "Role 3" ? 'selected' : '' }}>Role 3</option>
                                   <option value="Role 4" {{ $users->role == "Role 4" ? 'selected' : '' }}>Role 4</option>
                               </select>
                            </div>
                        </div>
